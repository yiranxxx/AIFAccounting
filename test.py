...
file_name = r"\\AIF-NAS01\AIF_Interns\202312\Accounting\ErrorFile\0326\Error cleaning data could not convert string\Pending Business\Mar 19 - Mar 25, 2022.pdf"

# Unpack the returned tuple into df0, df1, and df2
df0, df1, df2 = Extract_PDF(file_name)

if df0 is None :
    print("Skip file no information")
else:
