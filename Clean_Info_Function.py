...
def Clean_Info(df, Institution_Name):
    ...
    df_info = pd.DataFrame([[CommissionID, InstitutionName, ReportStartDate, ReportEndDate, FileNumber, AdvisorCode, AdvisorName, ContractDate, ContractStatus, Agency, District, WeekNumber]],
    ...
    return df_info, CommissionID, EndDate_Year, AdvisorName, WeekNumber
